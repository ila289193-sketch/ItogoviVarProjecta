...
func _ready() -> void:
    # Устанавливаем фильтрацию текстур на Linear, чтобы убрать "дрожание" пикселей при движении
    # Это особенно важно для масштабированных спрайтов (как у Character_body1_2d)
    if animated_sprite:
